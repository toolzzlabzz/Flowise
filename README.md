...
Deploy Flowise self-hosted in your existing infrastructure, we support various [deployments](https://toolz.ai/configuration/deployment)

-   [AWS](https://toolz.ai/deployment/aws)
-   [Azure](https://toolz.ai/deployment/azure)
-   [Digital Ocean](https://toolz.ai/deployment/digital-ocean)
...
-   <details>
    ...
    -   [HuggingFace Spaces](https://toolz.ai/deployment/hugging-face)
