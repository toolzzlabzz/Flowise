...
class UpstashRedisBackedChatMemory_Memory implements INode {
    ...
    constructor() {
        ...
        this.description = 'Realiza um sumário da conversação e armazena a memoria em um Servidor Upstash Redis'
        ...
        this.inputs = [
            ...
            },
            {
                ...
                name: 'sessionId',
                type: 'string',
                description: 'If not specified, a random id will be used. Learn <a target="_blank" href="https://toolz.ai">more</a>',
                default: '',
