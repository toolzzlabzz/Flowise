...
class Vectara_VectorStores implements INode {
    ...
    constructor() {
        ...
        this.description =
            'Atualizar ou inserir dados incorporados e realizar uma pesquisa de similaridade durante uma consulta usando o Vectara, um serviço de pesquisa alimentado por LLM.'
        ...
        this.inputs = [
            ...
            },
            {
                ...
                name: 'filter',
                description:
                    'Filter to apply to Vectara metadata. Refer to the <a target="_blank" href="https://toolz.ai/vector-stores/vectara">documentation</a> on how to use Vectara filters with Flowise.',
                type: 'string',
