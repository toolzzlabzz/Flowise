...
const ShareChatbot = ({ isSessionMemory }) => {
    ...
    return (
        <>
            ...
            {textField(title, 'title', 'Title', 'string', 'Toolzz Assistant')}
            {textField(
                titleAvatarSrc,
                'titleAvatarSrc',
                'Title Avatar Link',
                'string',
                `https://raw.githubusercontent.com/toolzzlabzz/Flowise-Dev/main/packages/ui/src/assets/images/flowise_logo_dark.png`
            )}
